...
import { PrivyAppsService } from "./services/apps.mjs";
...
export class PrivyClient {
    ...
    constructor({ appId, appSecret, apiUrl, authorizationKeyCacheMaxCapacity = DEFAULT_AUTHORIZATION_KEY_CACHE_MAX_CAPACITY, defaultRequestExpiryMs = DEFAULT_REQUEST_EXPIRY_MS, defaultHeaders, jwtVerificationKey, webhookSigningSecret, ...clientOptions }) {
