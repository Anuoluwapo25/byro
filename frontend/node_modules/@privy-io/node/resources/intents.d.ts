...
export declare class Intents extends APIResource {
     ...
     * ```
     */
    createPolicyRule(policyID: string, params: IntentCreatePolicyRuleParams, options?: RequestOptions): APIPromise<RuleIntentResponse>;
    /**
     ...
     * ```
     */
    updateKeyQuorum(keyQuorumID: string, params: IntentUpdateKeyQuorumParams, options?: RequestOptions): APIPromise<KeyQuorumIntentResponse>;
    /**
     ...
     * ```
     */
    updatePolicy(policyID: string, params: IntentUpdatePolicyParams, options?: RequestOptions): APIPromise<PolicyIntentResponse>;
    /**
     ...
     * ```
     */
    updateWallet(walletID: string, params: IntentUpdateWalletParams, options?: RequestOptions): APIPromise<WalletIntentResponse>;
}
...
export declare namespace RuleIntentCreateRequestDetails {
    interface Body {
        action: 'ALLOW' | 'DENY';
...
export declare namespace RuleIntentUpdateRequestDetails {
    interface Body {
        action: 'ALLOW' | 'DENY';
        conditions: Array<Body.UnionMember0 | Body.UnionMember1 | Body.UnionMember2 | Body.UnionMember3 | Body.UnionMember4 | Body.UnionMember5 | Body.UnionMember6 | Body.UnionMember7 | Body.UnionMember8 | Body.UnionMember9 | Body.UnionMember10 | Body.UnionMember11 | Body.UnionMember12 | Body.UnionMember13>;
        method: 'eth_sendTransaction' | 'eth_signTransaction' | 'eth_signTypedData_v4' | 'eth_signUserOperation' | 'eth_sign7702Authorization' | 'signTransaction' | 'signAndSendTransaction' | 'signTransactionBytes' | 'exportPrivateKey' | '*';
...
export type IntentRpcParams = IntentRpcParams.EthereumSignTransactionRpcInput | IntentRpcParams.EthereumSendTransactionRpcInput | IntentRpcParams.EthereumPersonalSignRpcInput | IntentRpcParams.EthereumSignTypedDataRpcInput | IntentRpcParams.EthereumSecp256k1SignRpcInput | IntentRpcParams.EthereumSign7702AuthorizationRpcInput | IntentRpcParams.EthereumSignUserOperationRpcInput | IntentRpcParams.SolanaSignTransactionRpcInput | IntentRpcParams.SolanaSignAndSendTransactionRpcInput | IntentRpcParams.SolanaSignMessageRpcInput | IntentRpcParams.SparkTransferRpcInput | IntentRpcParams.SparkGetBalanceRpcInput | IntentRpcParams.SparkTransferTokensRpcInput | IntentRpcParams.SparkGetStaticDepositAddressRpcInput | IntentRpcParams.SparkGetClaimStaticDepositQuoteRpcInput | IntentRpcParams.SparkClaimStaticDepositRpcInput | IntentRpcParams.SparkCreateLightningInvoiceRpcInput | IntentRpcParams.SparkPayLightningInvoiceRpcInput | IntentRpcParams.SparkSignMessageWithIdentityKeyRpcInput | IntentRpcParams.ExportPrivateKeyRpcInput;
