...
export declare namespace EthereumSignTransactionRpcInputParams {
...
export declare namespace EthereumSendTransactionRpcInputParams {
    interface Transaction {
        authorization_list?: Array<Transaction.AuthorizationList>;
        chain_id?: string | number;
        data?: string;
...
export interface EthereumTypedDataInput {
    ...
    primary_type: string;
    types: {
        [key: string]: Array<EthereumTypedDataInput.Type>;
    };
}
export declare namespace EthereumTypedDataInput {
    interface Type {
        name: string;
        type: string;
    }
...
export declare namespace EthereumSignUserOperationRpcInputParams {
 ...
 */
export type EthereumRpcInput = EthereumSignTransactionRpcInput | EthereumSendTransactionRpcInput | EthereumPersonalSignRpcInput | EthereumSignTypedDataRpcInput | EthereumSecp256k1SignRpcInput | EthereumSign7702AuthorizationRpcInput | EthereumSignUserOperationRpcInput;
/**
...
export declare namespace EthereumSendTransactionRpcResponseData {
...
export declare namespace EthereumSign7702AuthorizationRpcResponseData {
 ...
 */
export type EthereumRpcResponse = EthereumPersonalSignRpcResponse | EthereumSignTypedDataRpcResponse | EthereumSignTransactionRpcResponse | EthereumSendTransactionRpcResponse | EthereumSignUserOperationRpcResponse | EthereumSign7702AuthorizationRpcResponse | EthereumSecp256k1SignRpcResponse;
/**
