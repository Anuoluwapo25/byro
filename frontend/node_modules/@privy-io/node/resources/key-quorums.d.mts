...
export declare class KeyQuorums extends APIResource {
     ...
     * ```
     */
    _delete(keyQuorumID: string, params?: KeyQuorumDeleteParams | null | undefined, options?: RequestOptions): APIPromise<SharedAPI.SuccessResponse>;
    /**
...
export declare namespace KeyQuorums {
    export { type KeyQuorum as KeyQuorum, type KeyQuorumCreateParams as KeyQuorumCreateParams, type KeyQuorumUpdateParams as KeyQuorumUpdateParams, type KeyQuorumAuthorizationHeaders as KeyQuorumAuthorizationHeaders, type KeyQuorumDeleteParams as KeyQuorumDeleteParams, };
}
